...
function App() {
  ...
  const customBorderColors = [
    ...
    { name: 'Blu Oceano', color: '#0000FF', emoji: '🏝️' },
    ...
    { name: 'Azzurro Cielo', color: '#87CEEB', emoji: '🌤️' },
    { name: 'Indaco Profondo', color: '#4B0082', emoji: '🌌' },
    { name: 'Giallo Zafferano', color: '#FFD700', emoji: '🌼' },
    { name: 'Grigio Acciaio', color: '#808080', emoji: '🔩' },
    { name: 'Rosa Pesca', color: '#FF1493', emoji: '🍑' },
    { name: 'Blu Ghiaccio', color: '#B0E0E6', emoji: '❄️' },
    { name: 'Lavanda Provence', color: '#E6E6FA', emoji: '💐' },
    { name: 'Marrone Cioccolato', color: '#D2691E', emoji: '🍩' },
    { name: 'Turchese Marino', color: '#00CED1', emoji: '🌅' },
    { name: 'Rosa Corallo', color: '#FF6B6B', emoji: '🌺' },
    { name: 'Blu Ciano', color: '#00FFFF', emoji: '🏄' },
    { name: 'Rosa Orchidea', color: '#DA70D6', emoji: '🌺' },
    { name: 'Rosso Vino', color: '#800000', emoji: '🍇' },
    { name: 'Grigio Perla', color: '#EAEAEA', emoji: '🏖️' },
    { name: 'Viola Ametista', color: '#9966CC', emoji: '💎' },
    { name: 'Arancione Aragosta', color: '#FF4500', emoji: '🦞' },
    { name: 'Marrone Terra di Siena', color: '#A0522D', emoji: '🏜️' },
  ];
